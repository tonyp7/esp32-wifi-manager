 ...
 *
 * Causes TCP/IP stack to clean up this interface. This includes stopping the DHCP server or client, if they are
 * started.
 *
 ...
 *
 * Used for bulk search loops to avoid locking and unlocking every iteration. esp_netif_list_lock and
 * esp_netif_list_unlock must be used to guard the search loop
 *
 * @param[in]  esp_netif Handle to esp-netif instance
 *
