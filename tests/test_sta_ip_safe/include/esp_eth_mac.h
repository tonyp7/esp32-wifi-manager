...
struct esp_eth_mac_s
{
     ...
     *
     * @param[in] mac: Ethernet MAC instance
     * @param[in] ability: zero indicates that pause function is supported by link partner; non-zero indicates that
     * pause function is not supported by link partner
     *
     * @return
...
#define ETH_MAC_DEFAULT_CONFIG() \
    { \
        .sw_reset_timeout_ms = 100, .rx_task_stack_size = 4096, .rx_task_prio = 15, .smi_mdc_gpio_num = 23, \
        .smi_mdio_gpio_num = 18, .flags = 0, \
    }
