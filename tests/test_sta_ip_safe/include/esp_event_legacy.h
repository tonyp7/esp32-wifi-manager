 ...
 */
void
esp_event_set_default_eth_handlers(void);
 ...
 */
void
esp_event_set_default_wifi_handlers(void) __attribute__((deprecated));
 ...
 *               If cb is not NULL, it will be call when an event is received, after the default event callback is
 * completed
 *
