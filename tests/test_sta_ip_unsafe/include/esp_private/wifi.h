 ...
 */
esp_err_t
esp_wifi_internal_wapi_init(void);
 ...
 */
esp_err_t
esp_wifi_internal_wapi_deinit(void);
 ...
 */
esp_err_t
esp_wifi_internal_reg_netstack_buf_cb(wifi_netstack_buf_ref_cb_t ref, wifi_netstack_buf_free_cb_t free);
 ...
 */
esp_err_t
esp_wifi_internal_reg_rxcb(wifi_interface_t ifx, wifi_rxcb_t fn);
 ...
 */
esp_err_t
esp_wifi_internal_set_sta_ip(void);
 ...
 * @attention 2. Make sure that the receiver is able to receive the frame with the fixed rate if you want the frame to
 * be received
 *
 ...
 */
esp_err_t
esp_smartconfig_internal_stop(void);
 ...
 */
esp_err_t
esp_wifi_internal_update_mac_time(uint32_t time_delta);
 ...
 */
esp_err_t
esp_wifi_internal_set_log_level(wifi_log_level_t level);
 ...
 */
esp_err_t
esp_wifi_internal_set_log_mod(wifi_log_module_t module, uint32_t submodule, bool enable);
 ...
 */
bool
esp_wifi_internal_is_tsf_active(void);
 ...
 */
esp_err_t
esp_wifi_internal_set_mac_sleep(bool enable);
 ...
 */
esp_err_t
esp_wifi_set_tx_done_cb(wifi_tx_done_cb_t cb);
 ...
 */
esp_err_t
esp_wifi_internal_set_spp_amsdu(wifi_interface_t ifidx, bool spp_cap, bool spp_req);
 ...
 */
void
esp_wifi_internal_update_light_sleep_default_params(int min_freq_mhz, int max_freq_mhz);
 ...
 */
void
esp_wifi_set_sleep_delay_time(uint32_t return_to_sleep_delay);
 ...
 */
void
esp_wifi_set_keep_alive_time(uint32_t keep_alive_time);
